...
\item \label{adjacent-vertices}
Two different vertices $v_1 ≠ v_2$ of a polyhedron $P = \{ x ∈ ℝ^n ： Ax≤b\}$ are called \emph{adjacent}, if there exists a subsystem $A'x ≤ b'$ of $Ax≤b$ with
\begin{enumerate}[i)] 
...
% \item Finish the programming exercise 2 on computing all vertices of a given polyhedron. To find the exercise, follow the instructions on Moodle.
