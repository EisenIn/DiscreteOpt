...
& y_1, y_2, y_3 ≥ 0
\end{align*}
\item Let $(y_1, y_2, y_3)^T$ be a feasible solution to the dual of the converted LP. By adding up the two constraints we get $y_2+y_3=0$. Since $y_2, y_3 ≥ 0$, we have $y_2 = y_3 = 0$. Thus $y_1^T A = c^T$ is a feasible solution to the dual of the original LP.
\end{enumerate}
\end{solution}
